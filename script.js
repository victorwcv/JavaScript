...
const locations = [
  {
    name: "town square",
    "button text": ["Ir a la tienda", "Ir a la caverna", "Luchar contra el dragon"],
  ...
  {
    name: "cave",
    "button text": ["Fight slime", "Fight fanged beast", "Ir a la plaza del pueblo"],
    "button functions": [fightSlime, fightBeast, goTown],
    text: "Entras a la caverna. Ves algunos monstruos",
  },
  {
    name: "fight",
    "button text": ["Atacar", "Esquivar", "Correr"],
    "button functions": [attack, dodge, goTown],
    text: "Tu estas peleando contra un monstruo.",
  },
  {
    name: "kill monster",
